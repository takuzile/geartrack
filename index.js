...
const DEFAULT_DATA = {
  ...
  products: [
    { id:1, cat:'tire',  brand:'Continental', name:'GP5000 28c',  avgKm:4100, users:1240, heavy:68, mid:24, light:8,
      reviews:[
        { user:'ヘビー (380km/月)', km:3980, stars:5, text:'雨でもグリップ抜群。4000km近く使えた。' },
        { user:'ミドル (180km/月)', km:4300, stars:4, text:'コスパ良し。ライトなら5000kmいける。' },
      ],
    ...
    { id:2, cat:'tire',  brand:'Vittoria', name:'Corsa Pro TLR', avgKm:3900, users:560, heavy:55, mid:35, light:10,
      reviews:[{ user:'ヘビー (420km/月)', km:3600, stars:4, text:'グリップ最高。消耗はやや早め。' }],
    ...
    { id:3, cat:'chain', brand:'Shimano', name:'CN-M7100',       avgKm:3200, users:980, heavy:40, mid:45, light:15,
      reviews:[{ user:'ミドル (220km/月)', km:3100, stars:4, text:'変速スムーズ。メンテ次第で長持ち。' }],
    ...
    { id:4, cat:'chain', brand:'KMC', name:'X12-EL',             avgKm:3200, users:420, heavy:60, mid:30, light:10,
      reviews:[{ user:'ヘビー (350km/月)', km:2900, stars:5, text:'Shimanoより耐久性高く感じる。' }],
    ...
    { id:5, cat:'wheel', brand:'Zipp', name:'303 S',             avgKm:18000, users:210, heavy:70, mid:25, light:5,
      reviews:[{ user:'ヘビー (400km/月)', km:16000, stars:5, text:'剛性最高。リム面の摩耗は少ない。' }],
  ...
  rewards: [
    ...
    { id:2, brand:'Shimano',     product:'CN-M7100', target:6000, reward:'グリス プレゼント',  code:'SHI-GREASE' },
  ],
};
...
const DEFAULT_GEARS = [
  ...
  { id:4, name:'バーテープ',    cat:'bar',   limit:5000, used:0, start_date:null, product:'' },
  { id:5, name:'ブレーキパッド', cat:'brake', limit:5000, used:0, start_date:null, product:'' },
];
...
// Stravaトークンはメモリのみ（再起動時に再ログイン）
const stravaTokens = {}; // { userId: tokenStore }
...
app.post('/api/auth/register', async (req, res) => {
  ...
  if (db.users.find(u => u.email === email)) return res.json({ error: 'このメールアドレスは既に登録されています' });
